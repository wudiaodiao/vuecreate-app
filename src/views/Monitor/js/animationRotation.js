/*
 * @Author: your name
 * @Date: 2021-02-03 10:10:32
 * @LastEditTime: 2021-11-23 15:19:09
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \IBMS\ibms\src\views\Monitor\js\animationRotation.js
 */
    ...
    Rotation.prototype = {
        ...
        init: function (initType) {
            ...
            if (this.bgBox) {
                ...
                this.bgBox[0].style.left = -95 + "px";
                this.bgBox[0].style.top = - 95 + "px";
                this.bgBox[0].style.width = 186 + "px";
                this.bgBox[0].style.height = 186 + "px";
            }
        ...
        activationFun: function (ele, index) {
            ...
            this.doms.map(function (val, num) {
                ...
                var s2 = document.querySelector('.line2')
                var s1 = document.querySelector('.line1')
                s1.style.transform = "rotate(" + (45 + actualRotationAngle + _this.turnAngle) + "deg)"
                s2.style.transform = "rotate(" + (-45 + actualRotationAngle + _this.turnAngle) + "deg)"
                //每个子模块倒转
