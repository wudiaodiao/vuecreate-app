    ...
    <div class="PartInOut_cneter">
      <div :class="['public_page','PartInOutlist', $store.state.dtab ? 'index_off' : 'index_no']">
        <div class="PartInOutlist_main">
          ...
          <div class="PartInOutlist_main_zhon">
            <div class="Partlist_list">
              ...
              >
                ...
                <el-table-column type="index" :index="pageSize*(pageIndex-1)+1 " label="序号">
          ...
          <div class="PartInOutlist_main_botom" style="position: relative;top: -10px;">
            <div class="fenye">
              <el-pagination
                hide-on-single-page
                      ...
                      <ul class="left">
                        ...
                        <li>
                          ...
                          <i
                            class="user"
                            @click="
                              PartInOutGetSearchItem.isInDb && PartInOutGetSearchItem.ckdxh ? '': addTc(
                                'applyUser',
                                PartInOutGetSearchItem.applyUserNo
                              )
                            "
                          > {{PartInOutGetSearchItem.isInDb&&PartInOutGetSearchItem.ckdxh?'一级库':PartInOutGetSearchItem.applyUserName }}</i>
                        </li>
                        <li>
                        ...
                        <li>
                          ...
                          <i
                            ...
                            "
                          > {{PartInOutGetSearchItem.isInDb&&PartInOutGetSearchItem.ckdxh?'一级库':PartInOutGetSearchItem.approveUserName }}</i>
                        </li>
                        <li>
...
export default {
  ...
  methods: {
    ...
    async ExportSearchList() {
      //导出
      const res = await this.$api.MMS.PartInOut.ExportSearchList({
        start: this.Start,
        end: this.End,
    ...
    async PartInOutGetSearchList(pageIndex) {
      ...
      //出入库查询
      const res = await this.$api.MMS.PartInOut.GetSearchList({
